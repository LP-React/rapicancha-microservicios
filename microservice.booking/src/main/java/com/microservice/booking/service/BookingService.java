...
import com.microservice.booking.dto.*;
...
public class BookingService {
    ...
    public BookingResponse createBooking(
        ...
        private BookingResponse convertToResponse(
            ...
            response.setIdBooking(
                    booking.getIdBooking()
            );

            response.setIdSportCourt(
                    booking.getSportCourtId()
            );

            response.setCourtName(
                    court.getName()
            );
    ...
    public BookingResponse checkIn(
        ...
        CourtResponse court=
                courtClient.getCourt(
                        saved.getSportCourtId()
                );

        CustomerResponse customer=
                authClient.getCustomer(
                        saved.getCustomerAccountId()
                );
    ...
    searchBookings(
        ...
        if(sportCourtId!=null){
            ...
            bookings=
                    bookingRepository
                            .findBySportCourtIdOrderByDateAscStartTimeAsc(
                                    sportCourtId
                            );
