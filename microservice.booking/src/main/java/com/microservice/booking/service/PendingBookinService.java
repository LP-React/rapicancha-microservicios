...
public class PendingBookinService {
    ...
    public void processPending() {
        ...
        List<PendingBooking> pendings =
                pendingRepository.findByProcessedFalse();
            ...
            try {
                CourtResponse court =
                        courtClient.getCourt(
                                pending.getSportCourtId()
                        );

                CustomerResponse customer =
                        authClient.getCustomer(
                                pending.getCustomerAccountId()
                        );
